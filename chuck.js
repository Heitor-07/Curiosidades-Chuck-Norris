...
function curiosidade_chuck(){
    ...
    var curiosidades_chuck_norris = [
        ...
        { titulo: "Manipula o tempo", conteudo: "Chuck Norris não usa relógio. Ele decide que horas são."},
    ...
    var conteudo = curiosidade_escolhida.conteudo;

    document.getElementById('titulo').innerHTML = titulo;
    document.getElementById('curiosidade').innerHTML = conteudo;
